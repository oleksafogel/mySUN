...
export const metadata = {
    title: 'Cookie Policy • mySUN app',
    content: "n/a",
}

const CookiePolicy = () => {
    return <div className="cookiePolicy">
        <h1>Cookie Policy</h1>
        <p>
            Effective Date: 14-Oct-2023<br />
